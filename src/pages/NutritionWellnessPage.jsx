...
import {
    ...
    Heart, Utensils, Scale, Leaf, Users, TrendingUp, Baby
} from 'lucide-react';
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        ...
                        <div className="bg-gray-100 rounded-xl overflow-hidden aspect-[3/2]">
                            <MapEmbed title="KSK Healthcare - Nutrition & Wellness Services in Doddanekundi, Bengaluru" height={400} className="rounded-xl" />
                            <div className="p-4 bg-white">
                                <h4 className="font-semibold text-gray-900 mb-2">KSK Healthcare - Doddanekundi</h4>
                                <p className="text-sm text-gray-600 mb-2">
                                    Expert Nutrition & Wellness Center in Bengaluru
                                </p>
                                <a
                                    href="https://maps.app.goo.gl/LfKjkmm7VcutWpE27"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="inline-flex items-center space-x-1 text-emerald-600 hover:text-emerald-700 text-sm"
                                >
